...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002238185656 -1002164253150').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://boxagiwl49:KFLG4qW3DLweM6wy@cluster0.erys4lz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002055918522'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002184588707'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002236149210'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002055918522'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/RAS_HOW_TO_DOWNLOAD_FILE/15")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "212480f63512e5daef4996f621ca64270167cc9d")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'instantlinks.co')
SHORTENER_API2 = environ.get("SHORTENER_API2", "212480f63512e5daef4996f621ca64270167cc9d")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'instantlinks.co')
SHORTENER_API3 = environ.get("SHORTENER_API3", "212480f63512e5daef4996f621ca64270167cc9d")
